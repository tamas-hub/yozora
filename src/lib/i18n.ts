...
const DICT = {
  ...
  'score.loading': { ja: '天気を確認中…', en: 'Checking the weather…' },
  'score.error': {
  ...
  'hourly.note': { ja: '薄いバーは薄明中（空がまだ明るい時間）', en: 'Faded bars: twilight — the sky is still bright' },
  ...
  'moon.age': { ja: '月齢 {age}', en: 'Moon age {age}' },
  'moon.illum': { ja: '輝面比 {p}%', en: '{p}% lit' },
  ...
  'planets.count': { ja: '{n}個 見える', en: '{n} visible' },
