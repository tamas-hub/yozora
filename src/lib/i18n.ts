...
const DICT = {
  ...
  'native.tools': { ja: 'iOSアプリ操作', en: 'iOS app actions' },
  'native.liveForecast': { ja: '最新の予報', en: 'LIVE FORECAST' },
  'native.offlineSnapshot': { ja: '保存済み予報', en: 'SAVED FORECAST' },
  'native.updatedAt': { ja: '更新 {time}', en: 'Updated {time}' },
  'native.cachedAt': { ja: '取得 {time} ・ オフライン表示', en: 'Fetched {time} · offline copy' },
  'native.notUpdated': { ja: '未取得', en: 'Not updated yet' },
  'native.refresh': { ja: '再取得', en: 'Refresh' },
  'native.refreshing': { ja: '取得中', en: 'Refreshing' },
  'native.share': { ja: '今夜を共有', en: 'Share tonight' },
  'native.shareMessage': {
    ja: '{location}の今夜の星空指数は{score}/100。ベスト時間は{time}です。\nYOZORA 星空予報',
    en: 'Tonight’s stargazing score for {location} is {score}/100. Best around {time}.\nYOZORA Stargazing Forecast',
  },
  'pwa.offline': {
  ...
  'footer.linksAria': { ja: 'サポートとプライバシー', en: 'Support and privacy' },
  'footer.privacy': { ja: 'プライバシーポリシー', en: 'Privacy Policy' },
  'footer.support': { ja: 'サポート', en: 'Support' },
